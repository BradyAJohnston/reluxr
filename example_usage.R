...
lum_df <- read_plate("inst/Xfiles/tecan/calibration/calTecan1.xlsx")
...
#   counter <- counter + 1
#
#   bleed_df <- calc_bleed_df(working_df)
#
#   mean_mat <- bleed_df %>%
#     tibble_to_matrix(ratio_mean)
#
...
#
#   rand_mat <- matrix(rnorm(23 * 15), ncol = 23)
#
...
#     mutate(
#       lum = if_else(adjusted < instrument_sensitivity | adjusted < lum,
#                     adjusted,
#                     lum)
#     )
#
