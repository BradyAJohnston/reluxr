...
The goal of `{reluxr}` is to enable deconvolution of luminescencent plate-based
experiments. The implementation is based on the MatLab implementation from the
paper titled **1Deconvolution of Luminescence Cross-Talk in High-Throughput Gene
